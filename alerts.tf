resource "kubernetes_manifest" "prometheusrule_certificate_alerts" {
  ...
  manifest = {
    ...
    "spec" = yamldecode(file("${path.module}/prometheus_rules/certificate_alerts/certificate_rules.yaml"))
  }
}
...
resource "kubernetes_manifest" "prometheusrule_container_alerts" {
  ...
  manifest = {
    ...
    "spec" = yamldecode(file("${path.module}/prometheus_rules/container_alerts/container_rules.yaml"))
  }
}
...
resource "kubernetes_manifest" "prometheusrule_job_alerts" {
  ...
  manifest = {
    ...
    "spec" = yamldecode(file("${path.module}/prometheus_rules/job_alerts/job_rules.yaml"))
  }
}
...
resource "kubernetes_manifest" "prometheusrule_node_alerts" {
  ...
  manifest = {
    ...
    "spec" = yamldecode(file("${path.module}/prometheus_rules/node_alerts/node_rules.yaml"))
  }
}
...
resource "kubernetes_manifest" "prometheusrule_nodepool_alerts" {
  ...
  manifest = {
    ...
    "spec" = yamldecode(file("${path.module}/prometheus_rules/nodepool_alerts/nodepool_rules.yaml"))
  }
}
...
resource "kubernetes_manifest" "prometheusrule_pod_alerts" {
  ...
  manifest = {
    ...
    "spec" = yamldecode(file("${path.module}/prometheus_rules/pod_alerts/pod_rules.yaml"))
  }
}
